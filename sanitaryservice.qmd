...
<qgis version="3.40.8-Bratislava">
  <identifier>Sanitary_ServiceArea_1</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>Sanitary_ServiceArea_1</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" url="Server=gis02; Service=5155; Database=sd1publish; User=sa; Version=dbo.DEFAULT" mimeType="" name="SDE Feature Class" description="" type="ArcSDE Connection" size=""/>
  </links>
  <dates/>
  <fees></fees>
