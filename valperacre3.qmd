...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link description="" url="Server=KCFAPP02; Service=esri_sde; Database=sde; User=sde; Version=sde.DEFAULT" format="" mimeType="" name="SDE Feature Class" type="ArcSDE Connection" size=""/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial maxy="581778.44250000000465661" dimensions="2" miny="467479.46250000002328306" maxx="1592602.03349999990314245" minz="0" maxz="0" crs="EPSG:2891" minx="1534089.71750000002793968"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
